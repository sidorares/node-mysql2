...
- [Como as instruções preparadas (_prepared statements_) podem proteger contra ataques de injeção SQL](http://stackoverflow.com/questions/8263371/how-can-prepared-statements-protect-from-sql-injection-attacks)
...
### Usando Conjunto de Conexões (_pools_)
