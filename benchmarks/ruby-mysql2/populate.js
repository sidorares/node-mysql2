...
const Faker = require('charlatan');
const fs = require('fs');

const createSql = fs.readFileSync('./schema.sql').toString();
...
let five_words, twenty5_paragraphs;
for (let i = 0; i < num_rows; ++i) {
  five_words = Faker.Lorem.words(1 + rand(4))
    .join(' ')
    .slice(0, 10);
