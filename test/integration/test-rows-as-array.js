...
c.query({ sql: 'select 1+2 as a', rowsAsArray: false }, function(
  err,
  rows,
  fields
) {
...
c.execute({ sql: 'select 1+2 as a', rowsAsArray: false }, function(
  err,
  rows,
  fields
) {
...
c1.query({ sql: 'select 1+2 as a', rowsAsArray: true }, function(
  err,
  rows,
  fields
) {
...
c1.execute({ sql: 'select 1+2 as a', rowsAsArray: true }, function(
  err,
  rows,
  fields
) {
