...
Execute.prototype.readField = function(packet, connection) {
  ...
  if (this.fields.length == this.fieldCount) {
    if (!this.statementInfo.parser)
      this.buildParserFromFields(this.fields, connection);
...
Execute.prototype.buildParserFromFields = function(fields, connection) {
  ...
  if (!this.statementInfo.parser) {
    // compile row parser
    parserKey = getFieldsKey(fields, this.options);
    this.statementInfo.parser = connection.binaryProtocolParsers[parserKey];
    if (!this.statementInfo.parser) {
      this.statementInfo.parser = compileParser(fields, this.options, connection.config);
...
Execute.prototype.resultsetHeader = function(packet) {
  ...
  if (this.fields.length != this.resultFieldCount)
    this.statementInfo.parser = null;
