...
PreparedStatementInfo.prototype.close = function() {
  //this._connection.writePacket(new Packets.CloseStatement(this.id).toPacket(1));
  //this._connection.sequenceId = 0;
  this._connection.addCommand(new Command.CloseStatement(this.id));
};

PreparedStatementInfo.prototype.execute = function() {
  // WIP
  // this._connection.addCommand();
};
