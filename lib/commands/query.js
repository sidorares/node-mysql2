...
function Query(sql, options, callback)
{
  ...
  this._streamNames = options.infileMapping || {};
}
...
Query.prototype._findOrCreateReadStream = function(path) {
  if (this._streamNames[path])
    return this._streamNames[path];
...
Query.prototype._streamLocalInfile = function(connection) {
  this.connection.stream.on('pause', function() {
    this._localStream.pause();
  });
  this.connection.stream.on('drain', function() {
