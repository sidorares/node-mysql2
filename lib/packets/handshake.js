...
Handshake.prototype.setScrambleData = function(cb) {
  ...
  var authPluginData1 = new Buffer(8);
  
  for (var i=0;i<authPluginData1.length;i++) {
      authPluginData1.fill(Math.round(Math.random(8)*10))
  }
  
  var authPluginData2 = new Buffer(12);
  
  for (var i=0;i<authPluginData2.length;i++) {
      authPluginData2.fill(Math.round(Math.random(8)*10))
  }
  
  self.authPluginData1 = authPluginData1;
  self.authPluginData2 = authPluginData2;
