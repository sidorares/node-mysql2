...
class BaseConnection extends EventEmitter {
  ...
  _resolveNamedPlaceholders(options) {
    let unnamed;
    // Query-level namedPlaceholders: false explicitly overrides the connection-level setting.
    const useNamedPlaceholders =
      options.namedPlaceholders !== undefined
        ? options.namedPlaceholders
        : this.config.namedPlaceholders;
    if (useNamedPlaceholders) {
