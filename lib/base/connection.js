...
class BaseConnection extends EventEmitter {
  ...
  format(sql, values, namedPlaceholders) {
    ...
    // Keep query-level namedPlaceholders through formatting so connection
    // config cannot re-enable conversion after query() already resolved.
  ...
  _resolveNamedPlaceholders(options) {
    let unnamed;
    // Prefer query-level namedPlaceholders when set (same as pool.query).
